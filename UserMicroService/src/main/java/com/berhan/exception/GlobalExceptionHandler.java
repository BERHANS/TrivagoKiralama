...
import static com.berhan.exception.ErrorType.BAD_REQUEST_ERROR;
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RuntimeException.class)//eger uygulama çalışırken herhangi bir yerde bu sınıfı yakalarsa bu methodu çağırır
    @ResponseBody
