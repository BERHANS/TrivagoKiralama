...
public class JwtTokenManager {
    ...
    private final String SECRETKEY = "ivcJ},yuow2EM8HQB,B7kauFHoQt+;e311deZnwFbw+yD=PkPO";//girilen secret keyin çözülemiyor olması lazım
    private final String ISSUER = "Java11BoostAuth";//sahipliği de bu şekilde vermiş oluyoruz
    private final Long EXDATE = 1000L*60*5;//5 dakika demek bu
    /**
